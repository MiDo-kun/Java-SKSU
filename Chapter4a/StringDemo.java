...
public class StringDemo {
  public static void main(String args[]) {
    ...
    // Character that first appears alphabetically has lover unicode value
    System.out.println("Jonathan compared to Jonathan: " + name.compareTo("Jonathan"));
    System.out.println("Solomon compared to Jonathan: " + name.compareTo("Solomon"));
    ...
    // Need to add 1 to the endIndex paramter of substring
    ...
    // toString method is implicity called in the println method
    System.out.println("Sring representation of booleas expression 10 < 10: " + (10 < 10));

    // Note thre's no change in the String object name even after applying all these methods
    System.out.println("Name: " + name);
  }
}
